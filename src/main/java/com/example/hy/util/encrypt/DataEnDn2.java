package com.example.hy.util.encrypt;
...
public class DataEnDn2
{
	public static void main(String[] args)
	{
		String s = "hhhhuuuuuhhhhuuuu";
		s = DataEnDn2.AESencryptData(s, "qwedederqwededer", "qwedederqwededer");
		System.out.println(s);
		s = DataEnDn2.AESdecrypt(s, "qwedederqwededer", "qwedederqwededer");
		System.out.println(s);
	}
